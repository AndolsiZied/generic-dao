...
import com.ando.example.util.CleanInsertTestExecutionListener;
import com.ando.example.util.DataSetLocation;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(value = { "/application-context.xml", "/application-context-test.xml" })
@TestExecutionListeners({ DependencyInjectionTestExecutionListener.class, CleanInsertTestExecutionListener.class })
@DataSetLocation("classpath:/dao-dataset.xml")
public class BetDAOTest implements InitializingBean {

	/**
	 * {@link SpringBetDAOTest}'s default logger.
	 */
	...
	public void afterPropertiesSet() throws Exception {
		this.betDAO = context.getBean(BetDAO.class);
